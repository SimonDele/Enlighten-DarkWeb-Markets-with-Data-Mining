...
Let's now try to look at the evolution of the market with the collected data. Here you can see the number of ads posted per month from *January 2015* until *June 2017*.
...
Once more, the general  can be 
reach a pick of 5 thousand ads by the end of year.
...
After trying to make predictions on the seller (cf. [Sellers Predictions][- Sellers Predictions]), Prognoses on the origin of the ads have been made using Decision Tree method and Association Rules.  
