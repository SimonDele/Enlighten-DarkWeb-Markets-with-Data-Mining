...
```
ici jeujfuhhuhhusdkcbjwaecfhaoklcsdlajkvncahfslfdvhblfdsuihviausopvhfiudhsviujdnfzvshujoiuhocnuohoiuzhskcbfvkfjv
dfvujhfudvhousidvfhoijsdfoijv
adfvjihoifdjvoijfdi
...
med <-c()
for(i in 1:length(drugs)){
  matching_vector <- selectDrug2(drugs[i]);
