...
printdata <- function() {
  print.data <- subset (data[19012:19016,], select=-X)
  for(i in 2:4){
...
As it has been said before, basic statistics will be realized. Let's first analyse general distribution and trend of *AlphaBay Web Market*.
...
Globally, it appears that prices of *street sellers* are often largely higher than *AlphaBay* ads. In few cases both prices tend to be similar. (Please find in the last section all references used)
