...
For the past few years, a lot of *web market* has been developed and you can now buy items of any kinds. However, plenty of those marketplaces are growing up on *Dark Web*. Even if government attempts to fight against this kind of illegal market, new ones resurface or re-migrate frequently [add reference to our paper and to some of the papers referenced on the history]. On top of that, currently, we don't really know in detail how these websites operate.

The understanding of such illegal market is crucial to fight it. Information gathered in those websites, allows to identify which are the most wanted ads for the consumer and where they come from. Therefore it might be possible to detect the footprint of each seller and, thus, help the police to identify recurrent sellers with various hidden identities [reference]. 
...
Moreover, it is noticeable that most of these countries belong to powerful area, that is to say countries from the north of America or from Europe [powerful makes sense to the layman but not in academia; compare with g20 or g7 or whatever you want]. However, other countries such as *China* and *Afghanistan* are also present. 

![](.\Images\AlphaBayWorld.jpg)

@GTWorld

![](.\Images\AlphaBayEvolution.jpg)
@GTWorld
...
*AlphaBay Web Market* is a well known place for dealing drugs [use google trends to compare most popular existing qand past markets + google "hits" on the keyword]. This last chart has proved that. Thus, let's focus on the drug market.
