...
For the past few years, a lot of web market has been developed and especially on the *dark web*. Even if the government attempt to fight against this kind of illegal market.  
This paper
...
RateDrugAd <- function() {
  ...
  rate2 <- (NbAdFraud/NbAd)*100
  
  sprintf("Drugs Market represents %.2f %% of the AlphaBay Market \n Fraud : %.2f %%", rate,rate2)
