...
The understanding of such illegal market is crucial to fight it. Information gathered in those websites, allows to identify which are the most wanted ads for the consumer and where they come from. Therefore it might be possible to detect the footprint of each seller and, thus, help the police to identify recurrent sellers with various hidden identities.

//
[reference]. 
//

This paper presents a research carried out on one of the largest marketplace (specially for drugs) on Internet, the ***AlphaBay Dark Web Market***.  [update with notes on the fact that the marketplace is not up any more]
...
// ->
Moreover, it is noticeable that most of these countries are  economically powerful. For instance on these ten main countries, five belong to the Group of Seven (G7), only *Japan* and *Italy* are not present. And the other one are located in influential area where ? j'arrive pas a trouver mes mots dsl ^^ genre des zones ou il ya beaucoup de flux quoi, beaucoup d'echange, d activite...
//
...
//
Atlantic Coast 
country with huge harbour and important merchant shipping
East : not a lot of activities 
//
