...
Thanks to Sin Wee Lee and Andres Baravalle data have been collected on the *AlphaBay Dark Web Market*. Each rows of the data represent an ad and all the significant information can be find in the differents columns : title, brief, ad, price (in USD $) , url link, seller, payement, origin, destination, category, timestamp that is to say the date when the ad was collected, creation date of the ad, number of product sold since this date and a link to the image.

Thus the first step was to clean the data (remove character ... ) and made it readable in a computer way.  especially to focus on price because in the title
